...
<table border="1" class="responsive-table">
    ...
    foreach ($resultados as $resultado) {
        ...
        echo "<tr>
                <td><a href='presupuesto.php?&vel=40&peso=$peso&precio_venta={$resultado['precio_u_sIVA']}&formato={$resultado['formato']}&ComVent=20' target='_blank'>{$resultado['ID_formato']}</a></td>
