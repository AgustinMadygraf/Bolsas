...
function mostrarCalculosPresupuesto($totalCostoVariable, $horas_cerrar_venta, $val_unit_mano_obra, $precio_venta, $MgCont, $vel) {
    ...
    echo "<table>"; 
    echo "<tr><th rowspan = '2'>Descripción</th><th colspan='2'  style='text-align: center;' >Valor bruto</th><th style='text-align: center;' rowspan = '2'>IVA Crédito</th><th style='text-align: center;' rowspan = '2'>IVA Débito</th><th style='text-align: center;' rowspan = '2'>Valor Neto <br>Total</th></tr>";
    echo "<tr><th style='text-align: center;'>Total</th><th style='text-align: center;'>Unitario</th></tr>";
    echo "<tr><td>Ingrese la cantidad de bolsas a presupuestar:</td><td colspan='5' style='text-align: center;'><input type='number' id='cantidadBolsas' value='0'></td></tr>";
    echo "<tr><td>Costo Variable</td><td style='text-align: center;'>$<span id='Costo_variable_total_JS'>0.00</span></td><td style='text-align: center;'>$" . number_format($totalCostoVariable, 2, '.', ',') . "</td><td></td><td></td><td></td></tr>";
    echo "<tr><td>Horas para cerrar una venta y despachar pedido</td><td colspan='2' style='text-align: center;'>" . number_format($horas_cerrar_venta, 2, '.', ',') . "</td><td></td><td></td><td></td></tr>";
    echo "<tr><td>Costo de ejecutar Venta</td><td colspan='2' style='text-align: center;'>$" . number_format($CostoFijoVenta, 2, '.', ',') . "</td><td></td><td></td><td></td></tr>";
    echo "<tr><td>Costo </td><td style='text-align: center;'>$<span id='Costo_Total_JS'>0.00</span></td><td style='text-align: center;'>$<span id='Costo_unit_JS'>0.00</span></td><td style='text-align: center;'>$<span id='Costo_variable_total_debito_JS'>0.00</span></td><td></td><td></td></tr>";
    echo "<tr><td>Precio</td><td style='text-align: center;'>$<span id='Precio_Total_JS'>0.00</span></td><td style='text-align: center;'>$<span id='Precio_Unitario_JS'>0.00</span></td><td></td><td style='text-align: center;'>$<span id='Precio_Total_credito_JS'>0.00</span></td><td></td></tr>";
    echo "<tr><td>Margen de contribución</td><td style='text-align: center;'>$<span id='Margen_Contribucion_total_JS'>0.00</span></td><td style='text-align: center;'>$<span id='Margen_Contribucion_unit_JS'>0.00</span></td><td><span id='pocentaje_saldo_JS'>0.00</span> %</td><td>$<span id='saldo_IVA_JS'>0.00</span></td><td></td></tr>";
    echo "</table>";
